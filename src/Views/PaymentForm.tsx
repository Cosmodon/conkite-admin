...
class PaymentForm extends React.Component<{
	...
	validate = values => {
		...
		if (!(values.date_subscription_ends instanceof Date) || values.date_subscription_ends.toString() === 'Invalid Date') errors.date_subscription_ends = 'invalid date';
		if (!values.corrlinks_id) errors.corrlinks_id = 'Invalid id';
		if (values.date_created instanceof Date && values.date_subscription_ends instanceof Date && values.date_subscription_ends.valueOf() <= values.date_created.valueOf()) {
	...
	hasChanges = (formikProps) => {
		...
		if (JSON.stringify(formikProps.values) !== JSON.stringify(formikProps.initialValues)) {
								...
								<TableBody>
									...
									<TableRow>
										...
										<TableCell>
											...
											/>
											{props.errors.date_subscription_ends && props.touched.date_subscription_ends && <div>{props.errors.date_subscription_ends}</div>}
										</TableCell>
									</TableRow>
									<TableRow>
										<TableCell colSpan={2}>
